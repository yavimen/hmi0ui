...
export const GlobalProvider = ({ children }) => {
    const [globalData, setGlobalData] = useState(() => {
        ...
        const initialLocations = [
            ...
            { 
                id: 2, 
                name: "Городище", 
                description: `Розташоване в самому серці Рівненської області, городище на Рівненщині є одним з найбільш привабливих місць для любителів риболовлі. Його панорамні види на водойми, які відомі своєю різноманітністю риби, зробили його справжнім районом для тих, хто шукає спокій та відпочинок у природі. Покликане задовольнити найвибагливіші потреби рибалок, городище пропонує відмінні умови для лову різноманітних видів риби, включаючи щуку, окуня, карпа та багато інших. Чисте повітря, тихі водойми та природна краса навколишнього ландшафту роблять це місце ідеальним для відпочинку та насолоди риболовлею.`,
                imageUrl: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3HEZlkDOiPuQOg6_LFTYEFH32Rw3aqJftRQ&usqp=CAU`
        }
        ];
        ...
        const initialPersons = [
            ...
            { id: 2, fullName: "Енокентій Бест", dateOfBirth: new Date("1976-11-04") },
            { id: 3, fullName: "Гаврило Бечка", dateOfBirth: new Date("2002-05-11") },
        ];
    ...
    const deleteParticipant = (participant, tournamentId) => {
        const tournament = globalData.tournaments.find(x => x.id === tournamentId);
        tournament.participants = tournament.participants.filter(x => x.id !== participant.id);
